...
class CLydia implements ISingleton{
	...
	*/
	...
	/**
	* Singleton patten. Get the instance of the latest created object or create a new one.
	...
	*/
	public function FrontControllerRoute(){
		...
		//Check if the controller has a callable method in the controller class, if then call it
