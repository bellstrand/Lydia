<?php
/**
* A model for a guestbook, to show off some basic controller and model-stuff.
*
* @package LydiaCore
*/
class CMGuestbook extends CObject implements IHasSQL{
	...
	*
	* @param string $key is the string that is the key of the wanted SQL-entry in the array.
	*/
	...
	*/
	...
	/**
	* Read all entries from the guestbook and database.
	*/
